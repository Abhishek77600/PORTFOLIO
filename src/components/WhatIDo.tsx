        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Leveraging Python, SQL, and analytics tools to extract insights from data, perform statistical analysis, and create compelling visualizations.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building intelligent systems using machine learning, deep learning, NLP, and computer vision techniques for real-world applications.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
